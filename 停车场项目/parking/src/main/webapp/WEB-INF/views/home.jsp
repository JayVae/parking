...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<c:url value="/static/css/decor/style.css" />">
		...
		<script type="text/javascript" src="<c:url value="/static/js/commonDecode.js" />"></script>
		<script type="text/javascript" src="<c:url value="/static/js/validateboxRules.js" />"></script>		
	</head>
	<body class="easyui-layout" style="text-align:left">
		<div region="north" border="false" style="background:#79CDCD;text-align:center">
						<div id="header-inner">
				<table cellpadding="0" cellspacing="0" style="width:100%;">
					<tr>
						...
						<div style="color:#fff;font-size:22px;font-weight:bold;">
								<shiro:principal property="sitename"/>
							</div>
							<div style="color:#fff">
								<shiro:principal property="realname"/>,<shiro:principal property="rolename"/>
							</div>
						</td>
						<td>
		...
		<div region="west" split="true" title="菜单" style="width:250px;padding:5px;">
			<ul id="meunTree" class="easyui-tree" data-options="url:'menuTree.json',method:'get',animate:true"></ul>
		</div>
		<div region="center">
